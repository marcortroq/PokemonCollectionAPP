...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: WillPopScope(
        onWillPop: () async {
          // Establecer _isKeyboardVisible como false cuando se presiona el botón de retroceso
          _MyHomePageState()._setKeyboardVisibility(true);
          // Permitir que la navegación hacia atrás continúe
          return true;
        },
