...
class open_packNormal extends StatefulWidget {
  const open_packNormal({Key? key}) : super(key: key);

  @override
  State<open_packNormal> createState() => _StateOpen_packNormal();
}

class _StateOpen_packNormal extends State<open_packNormal> {
  double opacity = 1.0;
  ...
  int totalImages = 3; // Cambia esto al número total de imágenes que tienes
  ...
  double _getImageTopPosition(int index, double screenWidth) {
    ...
    switch (index) {
      case 0:
        return screenWidth * 1.21; // Ajusta estas posiciones según tu preferencia
      case 1:
        return screenWidth * 0.41;
      case 2:
        return screenWidth * 1.21;       
      default:
        return 0;
    }
  }
